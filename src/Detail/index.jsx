...
export default class Home extends React.Component {
    constructor() {
        super();
        var myData = []
        const list_child = ["description","quality","usage","cite","fund","copyright","author"]
        for(var item in testData){
            if(list_child.indexOf(item)!==-1){
                myData.push(testData[item])
        ...
        return (
            ...
            <div className='detail-bg'>
                <Row gutter={40}>
                    ...
                    <Col span={8}>
                        <Row className='detail-section'>
                            <Title level={4}>{this.state.allData.details.name}</Title>
                            {this.state.allData.details.content.map((sub_item, sub_index) => {
                                return (
                                    <div>
                                        <Text>{sub_item}</Text>
                                        <br />
